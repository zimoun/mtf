...
# print("# STF norm {:^15} {:^15} {:^15} {:^15} {:^15} {:^15} {:^15}".format(
#         'sol', 'ext', 'int', 
#         'Dext', 'Dint', 
#         'Next', 'Nint'
#         ))
...
print("# MTF   {:^15E} {:^15E} {:^15E} {:^15E} {:^15E} {:^15E}".format(
        ...
        E_mtf_diff, np.linalg.norm(yDsca-yDint), np.linalg.norm(yNsca+yNint)
        ))

# print("# STF {:^15} {:^15} {:^15} {:^15} {:^15} {:^15}".format(
#         'tot', 'ext', 'int', 
#         'diff', 'diffD', 'diffN'
#         ))
