...
kVacuum = 1 #2 * np.pi / wavelengthVacuum
muInt = 1
muExt = 1
...
W0 = createHelmholtz3dHypersingularBoundaryOperator(
    context, space, space, space, kExt, "W0")
...
t =  MTFextNeumannTrace
exportToGmsh(t, 'MTF-next-r', 'MTF_NextR.pos')
tI = -1j * t
exportToGmsh(tI, 'MTF-next-i', 'MTF_NextI.pos')

t =  MTFintNeumannTrace
exportToGmsh(t, 'MTF-nint-r', 'MTF_NintR.pos')
tI = -1j * t
exportToGmsh(tI, 'MTF-nint-i', 'MTF_NintI.pos')
...
refDext = MTFextDirichletTrace.L2Norm()
refNext = MTFextNeumannTrace.L2Norm()

refDint = (MTFintDirichletTrace +incDirichletTrace).L2Norm()
refNint = (MTFintNeumannTrace +incNeumannTrace).L2Norm()
