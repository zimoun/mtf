...
gD0_A = createGridFunction(
      context, P1_A, P0_A, evalIncDirichletTrace,
      surfaceNormalDependent=True)
gD0_C = createGridFunction(
      context, P1_C, P0_C, evalIncDirichletTrace,
      surfaceNormalDependent=True)
gN0_A = createGridFunction(
      context, P0_A, P1_A, evalIncNeumannTrace,
      surfaceNormalDependent=True)
gN0_C = createGridFunction(
      context, P0_C, P1_C, evalIncNeumannTrace,
      surfaceNormalDependent=True)

gD1_A = createGridFunction(
      context, P1_A, P0_A, evalIncDirichletTrace,
      surfaceNormalDependent=True)
gD1_B = createGridFunction(
      context, P1_B, P0_B, evalIncDirichletTrace,
      surfaceNormalDependent=True)
gN1_A = createGridFunction(
      context, P0_A, P1_A, evalIncNeumannTrace,
      surfaceNormalDependent=True)
gN1_B = createGridFunction(
      context, P0_B, P1_B, evalIncNeumannTrace,
      surfaceNormalDependent=True)

gD2_C = createGridFunction(
      context, P1_C, P0_C, evalIncDirichletTrace,
      surfaceNormalDependent=True)
gD2_B = createGridFunction(
      context, P1_B, P0_B, evalIncDirichletTrace,
      surfaceNormalDependent=True)
gN2_C = createGridFunction(
      context, P0_C, P1_C, evalIncNeumannTrace,
      surfaceNormalDependent=True)
gN2_B = createGridFunction(
      context, P0_B, P1_B, evalIncNeumannTrace,
      surfaceNormalDependent=True)
...
#
solD0_A = solution.gridFunction(0)
solD0_C = solution.gridFunction(1)
solN0_A = solution.gridFunction(2)
solN0_C = solution.gridFunction(3)

solD1_A = solution.gridFunction(4)
solD1_B = solution.gridFunction(5)
solN1_A = solution.gridFunction(6)
solN1_B = solution.gridFunction(7)

solD2_C = solution.gridFunction(8)
solD2_B = solution.gridFunction(9)
solN2_C = solution.gridFunction(10)
solN2_B = solution.gridFunction(11)


t = solD0_A
exportToGmsh(t, 'dir 0', 'dir0-aR.pos')
tI = -1j * t
exportToGmsh(tI, 'dir 0', 'dir0-aI.pos')

t = solD0_C
exportToGmsh(t, 'dir 0', 'dir0-cR.pos')
tI = -1j * t
exportToGmsh(tI, 'dir 0', 'dir0-cI.pos')

t = solD1_A
exportToGmsh(t, 'dir 1', 'dir1-aR.pos')
tI = -1j * t
exportToGmsh(tI, 'dir 1', 'dir1-aI.pos')

t = solD1_B
exportToGmsh(t, 'dir 1', 'dir1-bR.pos')
tI = -1j * t
exportToGmsh(tI, 'dir 1', 'dir1-bI.pos')

t = solD2_C
exportToGmsh(t, 'dir 2', 'dir2-cR.pos')
tI = -1j * t
exportToGmsh(tI, 'dir 2', 'dir2-cI.pos')

t = solD2_B
exportToGmsh(t, 'dir 2', 'dir2-bR.pos')
tI = -1j * t
exportToGmsh(tI, 'dir 2', 'dir2-bI.pos')



print('\n post \n')

nD0_A = solD0_A.L2Norm()
nD0_C = solD0_C.L2Norm()
nD1_B = solD1_B.L2Norm()
nD2_B = solD2_B.L2Norm()

nN0_A = solN0_A.L2Norm()
nN0_C = solN0_C.L2Norm()
nN1_B = solN1_B.L2Norm()
nN2_B = solN2_B.L2Norm()

nD1_A = solD1_A.L2Norm()
nD2_C = solD2_C.L2Norm()
dinc_A = gD1_A.L2Norm()
dinc_C = gD2_C.L2Norm()

nN1_A = solN1_A.L2Norm()
nN2_C = solN2_C.L2Norm()
ninc_A = gN1_A.L2Norm()
ninc_C = gN2_C.L2Norm()

jD_A = (solD0_A - solD1_A - gD0_A).L2Norm()
jD_C = (solD0_C - solD2_C - gD0_C).L2Norm()

jN_A = (solN0_A - solN1_A - gN0_A).L2Norm()
jN_C = (-solN0_C - solN2_C - gN0_C).L2Norm()

jD_B = (solD1_B - solD2_B).L2Norm()
jN_B = (solN1_B + solN2_B).L2Norm()
...
# lD0_A = solD0_A.coefficients()
# lD0_C = solD0_C.coefficients()
# lN0_A = solN0_A.coefficients()
# lN0_C = solN0_C.coefficients()

# lD1_A = solD1_A.coefficients()
# lD1_B = solD1_B.coefficients()
# lN1_A = solN1_A.coefficients()
# lN1_B = solN1_B.coefficients()

# lD2_C = solD2_C.coefficients()
# lD2_B = solD2_B.coefficients()
# lN2_C = solN2_C.coefficients()
# lN2_B = solN2_B.coefficients()
